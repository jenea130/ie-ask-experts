...
<div class="pricing">
  <div class="container">
    <div class="pricing__content">
      <div class="pricing__label label"><?php echo $label; ?></div>
    ...
    <div class="pricing__wrapper">
      <?php foreach ($items as $item) : ?>
        ...
        $items = $item['items'];
        ?>
        <div class="pricing__col card-plan">
          <div class="card-plan__body">
            ...
            <div class="card-plan__info">
              <div class="card-plan__price">
                <span class="js-price-monthly active"><?php echo $price; ?></span>
              </div>
              <div class="card-plan__label label">
                <span class="js-price-monthly active"><?php echo $label; ?></span>
              </div>
            </div>
          </div>
