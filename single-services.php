    ...
    <div class="container">
        ...
        <div class="projections__content">
          <div class="projections__logo">
            <svg width="106" height="72" viewBox="0 0 106 72" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="65.5023" cy="27.3834" r="23.7884" fill="#DADADA"></circle>
              <path d="M35.075 1.46352C35.2247 1.00287 35.8764 1.00287 36.0261 1.46353L37.1717 4.98924C37.2386 5.19525 37.4306 5.33473 37.6472 5.33473H41.3543C41.8387 5.33473 42.0401 5.95454 41.6482 6.23924L38.6491 8.41825C38.4738 8.54557 38.4005 8.77125 38.4675 8.97726L39.613 12.503C39.7627 12.9636 39.2355 13.3467 38.8436 13.062L35.8445 10.883C35.6692 10.7557 35.4319 10.7557 35.2567 10.883L32.2575 13.062C31.8657 13.3467 31.3384 12.9636 31.4881 12.503L32.6337 8.97726C32.7006 8.77125 32.6273 8.54557 32.452 8.41824L29.4529 6.23924C29.061 5.95453 29.2624 5.33473 29.7468 5.33473H33.4539C33.6706 5.33473 33.8625 5.19525 33.9295 4.98924L35.075 1.46352Z" fill="#FFCC4A"></path>
              <path d="M15.0779 63.5326C15.35 63.8048 15.2255 64.2695 14.8537 64.3691L4.54414 67.1316C4.17236 67.2312 3.83215 66.891 3.93177 66.5192L6.69421 56.2096C6.79383 55.8378 7.25856 55.7133 7.53073 55.9855L15.0779 63.5326Z" fill="#4EAF4E"></path>
              <circle cx="99.5009" cy="18.9829" r="5.88667" fill="#DADADA"></circle>
              <path d="M76.8932 22.3101H29.3841C28.1915 22.3101 27.2246 23.2769 27.2246 24.4696V56.8621C27.2246 58.0548 28.1915 59.0216 29.3841 59.0216H76.8932C78.0858 59.0216 79.0527 58.0548 79.0527 56.8621V24.4696C79.0527 23.2769 78.0858 22.3101 76.8932 22.3101Z" fill="white" stroke="#282828" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
              <path d="M76.8932 22.3101H29.3841C28.1915 22.3101 27.2246 23.2769 27.2246 24.4696V56.8621C27.2246 58.0548 28.1915 59.0216 29.3841 59.0216H76.8932C78.0858 59.0216 79.0527 58.0548 79.0527 56.8621V24.4696C79.0527 23.2769 78.0858 22.3101 76.8932 22.3101Z" fill="white" stroke="#282828" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
              <path d="M76.8932 48.728H29.3841C28.1915 48.728 27.2246 48.9991 27.2246 49.3335V58.4162C27.2246 58.7506 28.1915 59.0217 29.3841 59.0217H76.8932C78.0858 59.0217 79.0527 58.7506 79.0527 58.4162V49.3335C79.0527 48.9991 78.0858 48.728 76.8932 48.728Z" fill="#4EAF4E" stroke="#282828" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
              <path d="M61.7764 59.0217L70.4144 69.8192" stroke="#282828" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
              <path d="M44.5003 59.0217L35.8623 69.8192" stroke="#282828" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
              <path d="M44.501 41.7456V48.2241" stroke="#282828" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
              <path d="M53.1387 37.4265V48.224" stroke="#282828" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
              <path d="M61.7764 33.1077V48.2242" stroke="#282828" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
              <path d="M53.1387 22.31V15.8315" stroke="#282828" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
            </svg>
          </div>
          <h2 class="projections__title title">Financial Projections</h2>
          <div class="projections__text text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
        </div>
      ...
      <div class="projections__wrapper">
        ...
        <div class="projections__item">
          ...
          <div class="projections__subtitle subtitle">Financial Plan</div>
          <div class="projections__desc text">Keep your information current and review the documents on a regular basis (monthly or more often if needed). Review them with key individuals within your company.</div>
        </div>
        <div class="projections__item">
          <div class="projections__icon">
          ...
          <div class="projections__subtitle subtitle">Financial Ratios</div>
          <div class="projections__desc text">Ratios are useful when comparing your company with the competition on financial performance and also when benchmarking the performance of your company.</div>
        </div>
      </div>
    </div>
  </div>
